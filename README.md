...
1. **Score your pillars.** Every wheel starts with four: Mental, Physical, Productivity, Sociability. Click the hearts (0 = struggling, 5 = thriving), or click/drag directly on the chart — anywhere inside the grid snaps that pillar to the value you point at.
